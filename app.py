...
st.markdown("<style>.stApp {background: linear-gradient(135deg, #050816 0%, #111827 55%, #020617 100%); color: white;} h1,h2,h3 {color:#FFD700; text-shadow:0 0 10px rgba(255,215,0,0.35);} .stButton button {background: linear-gradient(135deg,#FFD700,#F59E0B); color:black; font-weight:900; border:none; border-radius:14px; height:60px; font-size:24px; letter-spacing:1px; box-shadow:0 0 18px rgba(255,215,0,0.35);} .stButton button:hover {transform:scale(1.03); transition:0.2s;} .stSelectbox div[data-baseweb='select'] > div {background-color:#1f2937; color:white; border:2px solid #FFD700; border-radius:12px; min-height:50px; font-weight:700;} .live {background:rgba(15,23,42,0.88); border-left:5px solid #FFD700; border-radius:14px; padding:14px 18px; margin:12px 0; font-size:18px; line-height:1.7; box-shadow:0 0 12px rgba(255,215,0,0.08);} .goal {text-align:center; font-size:52px; font-weight:900; color:#FFD700; letter-spacing:4px; text-shadow:0 0 18px rgba(255,215,0,0.8); margin:28px 0; animation:pulse 1s infinite alternate;} @keyframes pulse {from {transform:scale(1);} to {transform:scale(1.06);}} </style>", unsafe_allow_html=True)
# ===== ロゴ表示 =====
try:
